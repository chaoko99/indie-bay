/datum/map/torch
	...
	usable_email_tlds = list("freemail.cs")

	allowed_spawns = list("Cryogenic Storage", "Cyborg Storage")
	default_spawn = "Cryogenic Storage"

	station_name  = "ISV Clear Skies"
	station_short = "Clear Skies"
	dock_name     = "TBD"
	boss_name     = "Independent"
	boss_short    = "Independent"
	company_name  = "Independent"
	company_short = "Independent"

	map_admin_faxes = list("Arbitration Station")
	...
	default_law_type = /datum/ai_laws/independent_conservative
	use_overmap = 1
	num_exoplanets = 1
...
/datum/map/torch/send_welcome()
	var/welcome_text = "<center><img src = sollogo.png /><br /><font size = 3><b>ISV Clear Skies</b> Sensor Readings:</font><hr />"
	...
	post_comm_message("ISV Clear Skies Sensor Readings", welcome_text)
